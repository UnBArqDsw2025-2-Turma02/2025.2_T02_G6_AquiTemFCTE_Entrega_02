...
| US07   | EP03            | RF07            | Editar Anúncio       | Eu, como **Estudante da FCTE**, quero editar as informações de um anúncio meu já publicado, permitindo alterar suas fotos, descrição, categoria ou preço ou status (disponível ou indisponível), para que as informações dos meus itens sempre fiquem atualizados. |
...
| 2.0    | 21/09/2025 | Adição de Épicos 7 a 9, US 15 a 23 e tabela requisitos funcionais | [Ludmila Nunes](https://github.com/ludmilaaysha) | [Isaque Camargos](https://github.com/isaqzin) | Revisado e aprovado |