...
- Este fluxo ocorre em FB03. Se o navegador bloqueia popup, sistema mostra instrução para copiar o número manualmente.
...
Formulário com rótulos e validação inline.
...
| 1.1 | 21/09/2025 | Documentção da introdução, metodologia, conclusão, referências, senso crítico |[Caio Sabino](https://github.com/caiomsabino), [Isaque Camargos](https://github.com/isaqzin) e [Ludmila Nunes](https://github.com/ludmilaaysha) |  | - |
| 1.2 | 21/09/2025 | Inserção das especificações de caso de uso.|[Caio Sabino](https://github.com/caiomsabino), [Isaque Camargos](https://github.com/isaqzin) e [Ludmila Nunes](https://github.com/ludmilaaysha) |  | - |